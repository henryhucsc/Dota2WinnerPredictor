...
def main():
    ...
    with open('gamesdata.csv', 'rb') as csvfile:
        ...
        for row in csvreader:
            ...
            hero_ids_radiant = row[0:5]
            hero_ids_dire = row[5:10]
            print hero_ids_dire
            print hero_ids_radiant
    ...
    final_score = float(correct) / float(total)
    print correct
    print total
    print "\n\n Final Score = %f \n\n" % final_score
